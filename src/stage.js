...
function buildWaves() {
  ...
  // スナイパーゾーン: 1050を基点にギャップを2倍に拡張
  add(1050, 'sniper', 120, -40);
  add(1170, 'sniper', 360, -40);            // 1050+(60×2)
  for (let i = 0; i < 6; i++) add(1350 + i * 50, 'small', 60 + i * 72, -30); // 1050+(150×2), step 50
  add(1650, 'sniper', 200, -40);            // 1050+(300×2)
  add(1650, 'medium', 350, -50);
  add(1790, 'sniper', 300, -40);            // 1050+(370×2)
  add(1910, 'medium', 130, -50);            // 1050+(430×2)
